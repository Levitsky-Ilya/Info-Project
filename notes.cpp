...
#define DUMP_BEFORE_PEAKS 0 // type 1 to dump before selection peaks to dump.txt
...
{
    cout << "Amplitudes vector generation started..." << endl;
    ...
    cout << "Amplitudes vector generation completed for " << spent_time.count() << "s."<< endl;
